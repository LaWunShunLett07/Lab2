...
def test_calc_min_max_temperature():
    ...
    expected_min = 1
    expected_max = 24
    inMin, inMax = lab2.calc_min_max_temperature(test_list, test_list)
